 ...
 *
 * WHO CALLS THIS: every route under `/api/admin/` except the sign-in route
 * itself, which has to answer an operator standing in front of it. Every admin
 * route added after these must call it too — that is the point of it being one
 * function.
 */
